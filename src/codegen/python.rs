...
mod tests {
    ...
    #[test]
    fn emit_example_01() {
        let py = parse_file_and_emit("examples/idea9-ultra-dense-short/01-simple-function.ilo");
    ...
    #[test]
    fn emit_example_02() {
        let py = parse_file_and_emit("examples/idea9-ultra-dense-short/02-with-dependencies.ilo");
        assert!(py.contains("def prc("));
    }

    #[test]
    fn emit_example_03() {
        let py = parse_file_and_emit("examples/idea9-ultra-dense-short/03-data-transform.ilo");
    ...
    #[test]
    fn emit_example_04() {
        let py = parse_file_and_emit("examples/idea9-ultra-dense-short/04-tool-interaction.ilo");
        assert!(py.contains("def ntf("));
    }

    #[test]
    fn emit_example_05() {
        let py = parse_file_and_emit("examples/idea9-ultra-dense-short/05-workflow.ilo");
